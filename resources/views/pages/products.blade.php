...
@section('content')
    ...
    <section class="collection-header-section">
        <div class="container">
            <h1 class="collection-title">LEGO</h1>
        </div>
    </section>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="product-card">
                        <div class="product-image-wrapper">
                            ...
                            <img src="{{ asset('assets/products/10.jpg') }}" alt="LEGO Marvel" class="product-image">
                        </div>
                        <div class="product-info">
                            <h3 class="product-title">LEGO Marvel The Goat Boat 76208 Building Set - Thor Set with Toy Ship,
                                Stormbreaker, and Movie Inspired Thor, Korg, Valkyrie Mini Figures, Avengers Gifts for Kids,
                                Boys, and Girls Ages 8+</h3>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="product-card">
                        <div class="product-image-wrapper">
                            <span class="sold-out-badge">Sold out</span>
                            <img src="{{ asset('assets/products/11.jpg') }}" alt="LEGO DOTS" class="product-image">
                        </div>
                        <div class="product-info">
                            <h3 class="product-title">LEGO DOTS Adhesive Patches Mega Pack 41957 5in1 Set, DIY Stickers
                                Kids' Mosaic Crafts Kit, Personalized Decoration for Notebooks, Phone Cases or Room Décor
                            </h3>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="product-card">
                        <div class="product-image-wrapper">
                            <span class="sold-out-badge">Sold out</span>
                            <img src="{{ asset('assets/products/8.jpg') }}" alt="LEGO Friends" class="product-image">
                        </div>
                        <div class="product-info">
                            <h3 class="product-title">LEGO Friends Andrea's Theater School 41714 Building Toy Set for Kids,
                                Girls, and Boys Ages 8+ (1,154 Pieces)</h3>
